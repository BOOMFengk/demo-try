...
export class PostService {
   ...
   */
  // async paginate(options: PaginateOptions, callback?: QuerHook<PostEntity>) {
  //   const qb = await this.buildListQuery(
  //     this.repository.buldBaseQB(),
  //     options,
  //     callback,
  //   );
  ...
  protected async buildListQuery(
    ...
    newQb = this.querryOrderBy(newQb, orderBy);
